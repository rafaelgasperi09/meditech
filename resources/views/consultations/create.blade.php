        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg" style="min-height: 500px;">
                <div class="p-6 text-gray-900">
                    <livewire:search-dropdown path="{{route('api.patients')}}" consultation_id="{{$consultation->id}}" is_patient="true" key="patient_name"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg" >
                <div class="p-6 text-gray-900 relative" style="min-height: 500px;">
                   @foreach($inputs as $i)
                       <div class="">
                           @if($i->rapid_access)
