                                    ...
                                    <div class="wizard">
                                        <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                                            <li class="nav-item flex-fill" role="presentation" data-bs-toggle="tooltip" data-bs-placement="top" title="Personal Information">
                                                <a class="nav-link rounded-circle mx-auto d-flex align-items-center justify-content-center " href="#step1" id="step1-tab" data-bs-toggle="tab" role="tab" aria-controls="step1" aria-selected="true">
                                                    <i class="far fa-user"></i>
                                                </a>
                                            </li>
                                            <li class="nav-item flex-fill" role="presentation" data-bs-toggle="tooltip" data-bs-placement="top" title="Create an Appoinment">
                                            ...
                                            <div class="tab-pane fade" role="tabpanel" id="step2" aria-labelledby="step2-tab">
                                                ...
                                                <form>
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="input-block mb-3">
                                                                <label for="basicpill-pancard-input" class="form-label">Fecha</label>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="input-block mb-3">
                                                                <label for="basicpill-vatno-input" class="form-label">Hora</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="input-block mb-3">
                                                                <label for="basicpill-cstno-input" class="form-label">Doctor</label>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="input-block mb-3">
                                                                <label for="basicpill-servicetax-input" class="form-label">Sucursal</label>
													...
													<div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="input-block mb-3">
                                                                <label for="basicpill-cstno-input" class="form-label">Consultorio</label>
                                                                <input type="text" class="form-control" id="basicpill-cstno-input">
                                                            </div>
                                                        </div>
													</div>
