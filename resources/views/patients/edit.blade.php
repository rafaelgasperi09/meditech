                ...
                <div class="p-6 text-gray-900">
                    ...
                    @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="id_number" class="block mt-1 w-full" type="number" name="id_number" :value="$data->id_number"/>
                        ...
                        <div>
                            ...
                            <x-textarea-input id="whatsapp" class="block mt-1 w-full" type="email" name="whatsapp">{{$data->billing_address}}</x-textarea-input>
